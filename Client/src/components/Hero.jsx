...
const Hero = () => {
    const { navigate, getToken, axios, setSearchCities, toast } = useAppContext();
    ...
    return (
        <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-32 xl:32
         text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen capitalize'>
            ...
            <p className='max-w-130 mt-2 text-sm sm:text-base'>Unparalleled luxury and comfort await at the world's most exclusive
